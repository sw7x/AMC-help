	...
	<div class="panel panel-default stage1" style="margin-bottom:5px;">
        ...
        <div class="panel-heading nopadding">
			<h4 class="panel-title h4-<?php echo $rowa1['cid'];?>">
				<a class="collapsed categorylink category1" id="aaabbb" data-toggle="collapse" data-parent="accordion" href="#collapse<?php echo $rowa1['cid']?>">
		...
		<div id="collapse<?php echo $rowa1['cid']?>" class="panel-collapse collapse level1" >
			<div class="panel-body">
				...
				<?php
				$sqlb1="SELECT * FROM tbl_category WHERE tbl_category.parent_id=".$rowa1['cid']." GROUP BY cid ORDER BY cid ASC";
							...
							<div class="panel-body">
								...
								?>
									...
									<div id="collapse<?php echo $rowc1['cid']?>" class="panel-collapse collapse level3">
										...
										<?php 
										$sqlc2 = "SELECT * FROM tbl_category INNER JOIN tbl_docs ON tbl_category.cid = tbl_docs.categoryid  WHERE tbl_category.cid=".$rowc1['cid']." ORDER BY cid ASC";
										$queryc2 = $conn->prepare($sqlc2);
										$isExecute =  $queryc2->execute(array($rowb1['cid']));
